                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            CaipinEntity caipinEntity = new CaipinEntity();
//                            caipinEntity.setCaipinName(data.get(0));                    //餐品名称 要改的
//                            caipinEntity.setCaipinPhoto("");//照片
//                            caipinEntity.setCaipinTypes(Integer.valueOf(data.get(0)));   //餐品类型 要改的
//                            caipinEntity.setCaipinPrice(Integer.valueOf(data.get(0)));   //购买获得积分 要改的
//                            caipinEntity.setCaipinKucunNumber(Integer.valueOf(data.get(0)));   //餐品库存 要改的
//                            caipinEntity.setCaipinOldMoney(data.get(0));                    //餐品原价 要改的
