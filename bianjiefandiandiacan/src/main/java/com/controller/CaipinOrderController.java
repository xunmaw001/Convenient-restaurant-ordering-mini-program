...
//                            caipinOrderEntity.setAddressId(Integer.valueOf(data.get(0)));   //送餐地址 要改的
//                            caipinOrderEntity.setCaipinId(Integer.valueOf(data.get(0)));   //餐品 要改的
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : caipins) {
           //取值
            ...
            caipinOrderEntity.setCaipinId(caipinId);//餐品
